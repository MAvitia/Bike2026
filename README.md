...
- **📋 Plan tab** — All five days with maps, stops, and mileage. Save your own **pins** (interest points) — tap the map or use 📍 to mark your GPS spot. Pins are stored on your device. **📷 Trip Photos**: a button that opens the shared Google Drive folder so everyone uploads their photos there (see **[SETUP.md](SETUP.md)** section 4).
