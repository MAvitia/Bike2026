...
- **📋 Plan tab** — All five days with maps, stops, and mileage. Save your own **pins** (interest points) — tap the map or use 📍 to mark your GPS spot. Pins are stored on your device. **📷 Trip Photos**: snap/pick photos that upload straight into a shared Google Drive folder (optional Cloudflare Worker — see **[SETUP.md](SETUP.md)** section 4).
