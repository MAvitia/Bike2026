...
const TRIP = {
  ...
  waypoints: [
    ...
    { name: "Ohiopyle",                      lat: 39.86988, lng: -79.49159, day: 2, type: "poi",    desc: "Gorgeous state-park town — waterfalls by the trail. Great photo + ice cream stop." },
    ...
    { name: "Eastern Continental Divide (2,392 ft)", lat: 39.70436, lng: -78.91245, day: 3, type: "poi", desc: "Highest point of the whole trip — it's downhill from here!" },
    { name: "Big Savage Tunnel",             lat: 39.69221, lng: -78.91608, day: 3, type: "poi",    desc: "Lit tunnel ~3,300 ft long." },
    ...
    { name: "Paw Paw Tunnel, WV",            lat: 39.54733, lng: -78.46319, day: 3, type: "poi",    desc: "3,118 ft dark tunnel — walk bikes through, bring lights! Kids love it." },
    ...
    { name: "Fort Frederick State Park",     lat: 39.60784, lng: -78.00919, day: 4, type: "poi",    desc: "1756 stone fort by the trail — quick history stop." },
    { name: "Williamsport, MD",              lat: 39.59880, lng: -77.82635, day: 4, type: "lunch",  desc: "Lunch stop. Cyclist-friendly canal town." },
    { name: "Shepherdstown, WV",             lat: 39.43509, lng: -77.79879, day: 4, type: "poi",    desc: "Charming historic town — coffee / ice cream." },
    ...
    { name: "Great Falls Tavern",            lat: 38.99758, lng: -77.24855, day: 5, type: "poi",    desc: "DON'T SKIP! Walk the boardwalk to Olmsted Island overlook — dramatic falls." },
